...
$(function() {
	...
	JY={
		...
		Object:{notNull:function(obj) {//判断某对象不为空..返回true 否则 false
		...
		Model:{//loading框
			...
			//divId,fn 方法
			check:function(id,title,fn,w,h){
				if(!w){w=300;}
				if(!h){h='auto';}
				$("#"+id).removeClass('hide').dialog(
						{
							...
							title_html:true,
							buttons:[{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(fn) == 'function'){fn.call(this);}}}]
						});
						
			},
			edit:function(id,title,savefn,cancelfn,w,h){
				if(!w){w=300;}
				if(!h){h='auto';}
				...
				$("#"+id).removeClass('hide').dialog(
						{
							...
							title_html:true,
							buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;保存","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},
							         {html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}
									]
						});
						
			},
			//审核
			audit:function(id,title,savefn,rejectfn,cancelfn,w,h){
				if(!w){w=300;}
				if(!h){h='auto';}
				$("#"+id).removeClass('hide').dialog({resizable:true,modal:true,width:w,height:h,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"审核")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;同意","class":"btn btn-primary btn-xs",click:function(){if(typeof(savefn) == 'function'){savefn.call(this);}}},{html: "<i class='icon-undo bigger-110'></i>&nbsp;驳回","class":"btn btn-danger btn-xs",click:function(){if(typeof(rejectfn) == 'function'){rejectfn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			},
			//调整
			adjust:function(id,title,againfn,abandonfn,cancelfn,w,h){
				if(!w){w=300;}
				if(!h){h='auto';}
				$("#"+id).removeClass('hide').dialog({resizable:true,modal:true,width:w,height:h,title:"<div class='widget-header'><h4 class='smaller'>"+(JY.Object.notNull(title)?title:"调整")+"</h4></div>",title_html:true,buttons:[{html: "<i class='icon-ok bigger-110'></i>&nbsp;提交","class":"btn btn-primary btn-xs",click:function(){if(typeof(againfn) == 'function'){againfn.call(this);}}},{html: "<i class='icon-flag-alt bigger-110'></i>&nbsp;放弃","class":"btn btn-danger btn-xs",click:function(){if(typeof(abandonfn) == 'function'){abandonfn.call(this);}}},{html:"<i class='icon-remove bigger-110'></i>&nbsp;取消","class":"btn btn-xs",click:function(){$(this).dialog("close");if(typeof(cancelfn) == 'function'){cancelfn.call(this);}}}]});
			}
		},
