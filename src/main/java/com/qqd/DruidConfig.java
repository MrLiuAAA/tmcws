...
public class DruidConfig implements ServletContextInitializer{
    ...
    public void onStartup(ServletContext servletContext) throws ServletException {
        ...
        params.put("deny","192.168.2.1");//黑名单 存在共同时,deny优先于allow
        params.put("loginUsername","admin");//登陆查看信息的账号和密码
        params.put("loginPassword","123456");
        params.put("resetEnable", "false");//是否能够重置数据
        ...
        //忽略资源
        webStatFilter.setInitParameter("exclusions","*.js,*.gif,*.jpg,*.bmp,*.png,*.css,*.ico,/druid/*");
    }
}
